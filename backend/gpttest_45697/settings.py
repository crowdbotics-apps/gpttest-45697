"""
Django settings for gpttest_45697 project.
...
ROOT_URLCONF = 'gpttest_45697.urls'
...
WSGI_APPLICATION = 'gpttest_45697.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "gpttest_45697 API",
    "DESCRIPTION": "API documentation for gpttest_45697 App",
    "VERSION": "v1",
}
